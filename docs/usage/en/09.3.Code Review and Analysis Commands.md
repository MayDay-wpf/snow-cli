...
- **Runtime effect**: Project `AGENTS.md` is part of the built-in context inject chain. Snow auto-prepends global + project `AGENTS.md` (root → cwd) to **model-bound user messages**; the chat bubble still shows your typed text. See [AGENTS.md Context Inject](./30.AGENTS%20Context%20Inject.md).
