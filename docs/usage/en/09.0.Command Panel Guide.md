...
| Configuration & management | [09.4 Configuration and Management Commands](./09.4.Configuration%20and%20Management%20Commands.md) | `/home`, `/ide`, `/connect`, `/disconnect`, `/connection-status`, `/mcp`, `/usage`, `/permissions`, `/auto-format`, `/config`, `/help`, `/quit`, `/worktree`, `/add-dir`, `/backend`, `/loop`, `/profiles` |
