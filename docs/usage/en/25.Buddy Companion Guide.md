...
- **Post-hatch customization**: Use `/buddy set` to precisely update hat, eye, rarity, shiny, personality, species, and stats without hand-editing config files.
...
```bash
# List available hats / eyes / rarities / species / stats
/buddy set --list
