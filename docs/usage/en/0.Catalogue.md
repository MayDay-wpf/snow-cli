...
- [AGENTS.md Context Inject](./30.AGENTS%20Context%20Inject.md) - Optional opt-in prepend of global/project `AGENTS.md` chain to model-bound user messages (default off); ROLE stays on system path
...
- [Plan Mode Guide](./31.Plan%20Mode%20Guide.md) - Plan document structure and machine validation, approval hard gate, plan-manage phase acceptance, planStrictness scope gating, auto-archiving and resume
