...
- [Plan Mode Guide](./31.Plan%20Mode%20Guide.md) - plan-manage create/write_body primary path, machine validation, approval hard gate, phase acceptance, planStrictness, headless resume, auto-archiving
