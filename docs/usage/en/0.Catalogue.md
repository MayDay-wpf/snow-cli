...
- [AGENTS.md Context Inject](./30.AGENTS%20Context%20Inject.md) - Auto-prepend global/project `AGENTS.md` chain to model-bound user messages; ROLE stays on system path
