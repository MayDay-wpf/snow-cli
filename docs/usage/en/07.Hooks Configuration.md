...
Both prepend model-visible text while keeping the UI bubble on `typedMessage`. On send, hook/bash enrichment usually runs first, then built-in AGENTS prepend. Details: [AGENTS.md Context Inject](./30.AGENTS%20Context%20Inject.md).
