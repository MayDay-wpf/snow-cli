...
function checkNodeVersion() {
	...
	if (major < minVersion) {
		...
		console.error(
			`${colors.bright}${colors.yellow}  ⚠️  Node.js Version Compatibility Error${colors.reset}`,
		);
		console.error(
			`${colors.bright}${colors.yellow}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}\n`,
		);
		console.error(
			`${colors.yellow}Current Node.js version: ${currentVersion}${colors.reset}`,
		);
		console.error(
			`${colors.yellow}Required: Node.js >= ${minVersion}.x${colors.reset}\n`,
		);
		console.error(
			`${colors.green}Please upgrade Node.js to continue:${colors.reset}\n`,
		);
		...
		console.error(
			`${colors.cyan}# Or download from official website:${colors.reset}`,
		);
...
function tryInstallSharp() {
	try {
		...
		console.log(
			`${colors.yellow}Installing optional dependency: sharp (for SVG to PNG conversion)${colors.reset}`,
		);
		try {
			...
			console.log(
				`${colors.yellow}⚠ sharp installation failed (this is OK - SVG will be returned as-is)${colors.reset}`,
			);
			console.log(
				`${colors.cyan}  Reason: sharp requires native binaries that may not be compatible with your system${colors.reset}`,
			);
			return false;
		}
	}
...
async function main() {
	...
	const isUsingMirror =
		currentRegistry.includes('npmmirror.com') ||
	...
	console.log(
		`${colors.cyan}${colors.bright}  Snow AI - Installation Optimization Tips${colors.reset}`,
	);
	console.log(
		`${colors.cyan}${colors.bright}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}\n`,
	);
	...
	if (region === 'china') {
		console.log(
			`${colors.yellow}检测到您在中国大陆地区,建议配置 npm 镜像源以加速安装:${colors.reset}\n`,
		);
	...
	console.log(
		`${colors.cyan}Current registry: ${currentRegistry}${colors.reset}`,
	);
	console.log(
		`${colors.cyan}${colors.bright}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${colors.reset}\n`,
	);
