...
export const es: TranslationKeys = {
	...
	configScreen: {
		...
		basicModel: 'Modelo Básico(Escribir para buscar):',
	...
	helpPanel: {
		...
		bashModeTitle: '🔲 Modo Bash:',
		bashModeTrigger: '!`comando`<duración de espera opcional ms>',
		bashModeDesc: 'Ejemplo: !`ls -l`<5000>',
	...
	customCommand: {
		...
		locationLabel: 'Seleccionar ubicación de guardado:',
		locationGlobal: 'Global',
		locationProject: 'Proyecto',
		locationGlobalInfo: 'Disponible en todos los proyectos (~/.snow/commands/)',
		locationProjectInfo: 'Solo disponible en este proyecto (.snow/commands/)',
	...
	bash: {
		sensitiveCommandDetected: 'COMANDO SENSIBLE DETECTADO',
		sensitivePattern: 'Patrón:',
		sensitiveReason: 'Razón:',
