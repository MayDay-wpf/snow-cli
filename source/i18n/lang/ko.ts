...
export const ko: TranslationKeys = {
	...
	configScreen: {
		...
		anthropicCacheTTL: 'Anthropic 캐시 TTL:',
		anthropicCacheTTL5m: '5분 (기본값)',
	...
	themeSettings: {
		...
		simpleMode: '간단 모드:',
		simpleModeInfo: '간단 모드를 활성화하여 인터페이스 단순화',
		enabled: '[✓] 활성화',
		disabled: '[ ] 비활성화',
		darkTheme: '다크 테마',
	...
	helpPanel: {
		...
		bashModeTitle: '🔲 Bash 모드:',
		bashModeTrigger: '!`명령`<선택적 타임아웃 시간ms>',
		bashModeDesc: '예시: !`ls -l`<5000>',
		navigationTitle: '📋 탐색:',
	...
	hooksConfig: {
		...
		hookTypes: {
			...
			toolConfirmation: '툴의 제2확인 중에 유발된(민감한 단어의 확인을 포함)',
	...
	customCommand: {
		...
		locationLabel: '저장 위치 선택:',
		locationGlobal: '전역',
		locationProject: '프로젝트',
		locationGlobalInfo: '모든 프로젝트에서 사용 가능 (~/.snow/commands/)',
		locationProjectInfo: '이 프로젝트에서만 사용 가능 (.snow/commands/)',
	...
	chatScreen: {
		...
		statusWorking: '작업 중',
		statusIndexing: '코드베이스 색인 중...',
		statusWatcherActive: '파일 감시자 활성 - 코드 변경 모니터링',
		statusWatcherActiveShort: '감시',
		statusFileUpdated: '업데이트됨: {file}',
		statusFileUpdatedShort: '업데이트됨',
		statusCreating: '생성 중...',
		statusSaving: '저장 중...',
	...
	skillsCreation: {
		title: '새 스킬 만들기',
		nameLabel: '스킬 이름:',
		nameHint: '소문자, 숫자, 하이픈만 사용 가능 (최대 64자)',
		namePlaceholder: 'my-skill-name',
		descriptionLabel: '설명:',
		descriptionHint: '이 스킬의 용도와 사용 시점에 대한 간단한 설명',
		descriptionPlaceholder: '간단한 설명...',
		locationLabel: '위치 선택:',
		locationGlobal: '전역 (~/.snow/skills/)',
		locationGlobalInfo: '모든 프로젝트에서 사용 가능',
		locationProject: '프로젝트 (.snow/skills/ 프로젝트 루트)',
		locationProjectInfo: '이 프로젝트에서만 사용 가능',
		confirmQuestion: '이 스킬을 만드시겠습니까?',
		confirmYes: '예, 만들기',
		confirmNo: '아니오, 취소',
		escCancel: 'ESC 키로 취소',
		errorInvalidName: '잘못된 스킬 이름',
		errorExistsBoth:
			'스킬 "{name}"이(가) 전역 및 프로젝트 위치 모두에 이미 존재합니다',
		errorExistsGlobal:
			'스킬 "{name}"이(가) 전역 위치 (~/.snow/skills/)에 이미 존재합니다',
		errorExistsProject:
			'스킬 "{name}"이(가) 프로젝트 위치 (.snow/skills/)에 이미 존재합니다',
	},
	askUser: {
		header: '[사용자 입력 필요]',
		customInputOption: '사용자 정의 입력...',
	...
	toolConfirmation: {
		...
		tool: '도구:',
		tools: '도구:',
		toolsInParallel: '{count}개 도구 병렬 실행',
		sensitiveCommandDetected: '민감한 명령 감지됨',
		pattern: '패턴:',
		reason: '이유:',
		requiresConfirmation:
			'이 명령은 YOLO/항상 승인 모드에서도 확인이 필요합니다',
		arguments: '인수:',
		selectAction: '작업 선택:',
		enterRejectionReason: '거부 사유 입력:',
		pressEnterToSubmit: 'Enter를 눌러 제출',
		confirmed: '확인됨',
		approveOnce: '승인(한 번)',
		alwaysApprove: '이 도구 항상 승인',
		rejectWithReply: '답변과 함께 거부',
		rejectEndSession: '거부 (세션 종료)',
	},
	bash: {
		sensitiveCommandDetected: '민감한 명령이 감지됨',
		sensitivePattern: '패턴:',
		sensitiveReason: '이유:',
		executeConfirm: '이 명령은 확인이 필요합니다. 계속하시겠습니까?',
		confirmHint: 'y를 눌러 실행, n을 눌러 취소, 또는 ESC를 눌러 돌아가기',
		executingCommand: '명령 실행 중...',
		timeout: '타임아웃:',
		customTimeout: '(사용자 지정)',
		backgroundHint: 'Ctrl+B로 백그라운드로 이동',
	},
	backgroundProcesses: {
		title: '백그라운드 프로세스',
		status: '상태',
		...
		statusFailed: '실패',
		duration: '기간',
		navigateHint: '↑↓ 탐색 | Enter 선택한 항목 종료 | ESC 닫기',
		emptyHint: '백그라운드 프로세스가 없습니다',
	},
	fileRollback: {
		title: '파일 롤백 확인',
	...
	usagePanel: {
		...
		chart: {
			...
			cacheHit: '캐시 히트',
			cacheCreate: '캐시 생성',
			moreAbove: '↑ 위에 {count}개 더 있음 (↑ 화살표 사용)',
			in: '입력:',
			out: '출력:',
			hit: '히트:',
			create: '생성:',
			total: '총계:',
			moreBelow: '↓ 아래에 {count}개 더 있음 (↓ 화살표 사용)',
		},
		loading: '사용 통계 로딩 중...',
		error: '오류: {error}',
	...
	workingDirectoryPanel: {
		title: '작업 디렉터리',
		loading: '로딩 중...',
		noDirectories: '디렉터리를 찾을 수 없습니다',
		defaultLabel: '[기본값]',
		markedCount: '{count}개 디렉터리가 삭제 대상으로 표시됨',
		markedCountSingular: '개 디렉터리',
		markedCountPlural: '개 디렉터리',
		navigationHint:
			'↑↓ 탐색 | Space 표시/해제 | A 새로 추가 | D 표시된 항목 삭제 | ESC 닫기',
		addTitle: '작업 디렉터리 추가',
		addPathLabel: '경로: ',
		addPathPrompt: '디렉터리 경로 입력:',
		addErrorEmpty: '경로는 비워둘 수 없습니다',
		addErrorFailed: '디렉터리 추가 실패(이미 존재하거나 잘못된 경로)',
		addHint: 'Enter로 추가, ESC로 취소',
		confirmDeleteTitle: '삭제 확인',
		confirmDeleteMessage: '{count}개 디렉터리를 삭제하시겠습니까?',
		confirmDeleteMessagePlural: '{count}개 디렉터리를 삭제하시겠습니까?',
		confirmHint: 'Y로 확인, N으로 취소',
		alertDefaultCannotDelete: '기본 디렉터리는 삭제할 수 없습니다',
	},
	sessionListPanel: {
		title: '재개',
		loading: '세션 로딩 중...',
		...
		searching: '검색 중...',
		navigationHint:
			'검색하려면 입력 • ↑↓ 탐색 • 스페이스 표시 • D 삭제 • Enter 선택 • ESC 닫기',
		moreAbove: '↑ {count}개 더 위',
		moreBelow: '↓ {count}개 더 아래',
		scrollToLoadMore: '(더 불러오려면 스크롤)',
		untitled: '제목 없음',
		now: '지금',
	},
	mcpInfoPanel: {
		title: 'MCP 서비스',
		loading: 'MCP 서비스 로딩 중...',
		refreshing: '서비스 새로고침 중...',
		toggling: '{service} 전환 중...',
		refreshAll: '모든 서비스 새로고침',
		noServices: '사용 가능한 MCP 서비스가 감지되지 않음',
		error: '오류: {message}',
		statusSystem: '(시스템)',
		statusExternal: '(외부)',
		statusDisabled: '(비활성화)',
		statusFailed: '실패',
		navigationHint: '↑↓ 탐색 • Enter 재연결 • Tab 서비스 전환',
