...
export const zh: TranslationKeys = {
	...
	privacySettings: {
		...
		scopeSelectInfo: '先选择 API 配置保存位置',
		urlLabel: 'URL(全路径)',
	...
	commandPanel: {
		...
		commandOutput: {
			...
			buddy: {
				...
				usage:
					'用法: /buddy [status|hatch [名字] [--species=类型] [--list-species] [--personality=文本]|pet|rename <名字>|say <消息>|mute|unmute|reset]',
