...
export const ja: TranslationKeys = {
	...
	sessionListPanel: {
		...
		searching: '検索中...',
		navigationHint:
			'検索するには入力 • ↑↓ ナビゲート • スペース マーク • D 削除 • Enter 選択 • ESC 閉じる',
		moreAbove: '↑ {count}件以上',
		moreBelow: '↓ {count}件以上',
	...
	mcpInfoPanel: {
		title: 'MCPサービス',
		loading: 'MCPサービスを読み込み中...',
		refreshing: 'サービスを更新中...',
		toggling: '{service}を切り替え中...',
		refreshAll: 'すべてのサービスを更新',
		noServices: '利用可能なMCPサービスが検出されません',
		error: 'エラー: {message}',
		statusSystem: '(システム)',
		statusExternal: '(外部)',
		statusDisabled: '(無効)',
		statusFailed: '失敗',
		navigationHint: '↑↓ ナビゲート • Enter 再接続 • Tab サービス切替',
		pleaseWait: 'お待ちください...',
	},
};
